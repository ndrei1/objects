...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet :
  ...
  override def mostRetweetedAcc(acc: Tweet): Tweet = right.mostRetweetedAcc(left.mostRetweetedAcc(if elem.retweets < acc.retweets then acc else elem))
...
object Main extends App :
  val set1 = Empty()
  val a = Tweet("a", "a body", 7)
  val b = Tweet("b", "b body1", 6)
  val c = Tweet("c", "c body11", 7)
  val d = Tweet("d", "d body111", 7)
  val e = Tweet("e", "e body1111", 9)
